...
EditableGrid.prototype.loadJSON = function(c, e, a) {
    this.lastURL = c;
	alert("EditableGrid.prototype.loadJSON has this parameter c:"+c);
    var b = this;
    if (!window.XMLHttpRequest) {
...
EditableGrid.prototype.getGroupTaskId = function(a) {
    return (a < 0 || a >= this.data.length) ? null : this.data[a]["grouptaskid"]
};
EditableGrid.prototype.getTaskId = function(a) {
    return (a < 0 || a >= this.data.length) ? null : this.data[a]["taskid"]
};
...
CellRenderer.prototype.renderArchico = function(cell, id, grouptaskid, taskid, level) {
    cell.innerHTML = "<i onclick=\"location.href = 'index.php?level="+level+"&project="+id+"&grouptaskid="+grouptaskid+"&taskid="+taskid+" class='fa fa-edit green' ></i>";
};
